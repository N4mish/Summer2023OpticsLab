...
# reading csv file
with open('Data\June8\Combined3dPlot.csv', newline='') as csvfile: # this is a Windows path. If using UNIX based systems change accordingly
    reader = csv.DictReader(csvfile)
    for row in reader:
        if (row['Polarizer Angle'] != '' and row['HWP Angle'] != '' and row['Power'] != ''): # avoids blank lines
